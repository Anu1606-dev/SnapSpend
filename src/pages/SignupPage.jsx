  ...
  return (
    <div className="min-h-screen flex">
      <div className="hidden lg:flex lg:w-1/2 bg-slate-900 dark:bg-surface flex-col justify-between p-12 relative overflow-hidden">
        <div className="absolute -top-24 -right-24 w-96 h-96 bg-mint/15 rounded-full blur-3xl" />
        <div className="absolute -bottom-32 -left-16 w-96 h-96 bg-electric/15 rounded-full blur-3xl" />
        <div className="absolute top-1/2 left-1/3 w-64 h-64 bg-magenta/10 rounded-full blur-3xl" />
      ...
      <div className="flex-1 flex items-center justify-center bg-slate-50 dark:bg-void px-6 py-12 transition-colors duration-200">
        <div className="w-full max-w-sm">
          ...
          <p className="text-sm text-slate-500 dark:text-cloud mb-8">Start understanding your spending today.</p>
          ...
          <p className="text-sm text-slate-500 dark:text-cloud mt-6 text-center">
            ...
            <Link to="/login" className="text-blue-600 dark:text-electric font-medium hover:underline">
              Log in
            </Link>
          </p>
        </div>
