...
export default function Sidebar() {
  return (
    <aside className="hidden md:flex md:flex-col w-60 shrink-0 bg-bg-panel text-slate-200 min-h-screen sticky top-0">
            ...
            <NavLink
              ...
              className={({ isActive }) =>
                `group flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-colors ${
                  isActive ? 'bg-bg-inset text-white' : 'text-slate-400 hover:bg-white/5 hover:text-slate-100'
                }`
              }
            >
